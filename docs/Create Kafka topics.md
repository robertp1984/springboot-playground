...
* Create Kafka topic playground.stickynote.avro with 9 partitions and replication factor of 3
```bash
kafka-topics --bootstrap-server kafka1:29092 --create --topic playground.stickynote.avro --partitions 9 --replication-factor 3
```
